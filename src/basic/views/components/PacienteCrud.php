    ...
    <div class="container">
            ...
            <div>
                <form action="">
                    ...
                    <div class="form-group">
                        <label for="patologia">Patologias</label>
                        <select id="patologia" class="form-control" v-model="activemodel.patologia" multiple>
        ...
        <table class="table" id="my-table">
            ...
            <tr v-for="(model,key) in models" v-bind:key="model[modelfields[0]]">
                ...
                <td>
                    <div v-for="pat in model.patologia">
                    {{pat.nombre}}
                    </div>
                </td>
                <td>
    ...
    const Paciente = {
        ...
        methods: {
            ...
            getModels: function() {
                ...
                self.errors = {};
                // var filters = self.normalizeFilters();
                axios.get('/apiv1/' + self.modelname + '?page=' + self.currentPage, {
                        params: self.filter
                    })
                    .then(function(response) {
                        // handle success
