    ...
    <div class="container">
            ...
            <div>
                <form action="">
                    ...
                    <div class="form-group">
                        ...
                        <select id="horarios" class="form-control" v-model="activemodel.horarios" multiple>
                            <template v-for="horario in horarios">
                            <option :value="horario.id_hatencion">{{horario.dia}}</option>
                            <option :value="horario.id_hatencion">{{horario.desde}}</option>
                            <option :value="horario.id_hatencion">{{horario.hasta}}</option>
        ...
        <table class="table" id="my-table">
            ...
            <tr v-for="(model,key) in models" v-bind:key="model[modelfields[0]]">
                ...
                <td>
                    <div v-for="horario in model.horarios">
                    {{cat.nombre}}
                    </div>
                </td>
                <td>
    ...
    const Medico = {
        ...
        methods: {
            getHorarios(){
                ...
                axios.get('/apiv1/horaatencion')
                    .then(function (response) {
                        self.horacios = response.data;
                    })
